...
public class SuccessfulLogin {
    ...
    public void SuccessfulLoginTest(String userName, String password){
        ...
        WebElement userAlPagesButton = driver.findElement(By.id("react-burger-menu-btn"));

        Assert.assertTrue(userAlPagesButton.isDisplayed(), "Visible only if successful login");
    }
